...
\begin{document}
	...
	\section{Architecture Code}
		...
		\section{Limites}
		Comme nous l'avons dit en 3.1, le choix de l'intervalle entre les mesures à 0.5s entraîne des limites pour certaines vitesses qui peuvent passer à travers la zone de flash des 30m, en effet un vehicule roulant à plus de $60 m/s$ (soit $216km/h$) pourrait parcourir les 30m en moins de 0.5s et donc dans certains cas éviter d'être flashé en roulant à une vitesse assez précise.\\
		Cette limite peut être quantifiée avec certaines conditions:
		\begin{itemize}
