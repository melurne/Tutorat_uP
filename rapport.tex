...
\begin{document}
	...
	\author{Corentin GIELEN, Florian DERLIC, Miaoqi WANG, Maxence NEUS}
	\maketitle
	...
	\section{Architecture Code}
		...
		Pour envoyer les mesures à l'imprimante nous devons utiliser la liaison série de l'ATMEGA comme décrit en 2.2.3.
		\begin{lstlisting}
